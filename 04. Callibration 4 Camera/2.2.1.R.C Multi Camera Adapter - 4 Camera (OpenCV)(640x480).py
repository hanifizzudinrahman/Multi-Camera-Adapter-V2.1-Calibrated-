    ...
    if cap.isOpened():
        ...
        while cv2.getWindowProperty("CSI Camera", 0) >= 0:
            ...
            if key == ord("q"):
                ...
                if cam == 1:
                    cv2.imwrite("Hasil_Gambar/R.C.Camera_A_ %s.jpg" % now, imgCropFinal)
                elif cam == 2:
                    cv2.imwrite("Hasil_Gambar/R.C.Camera_B_ %s.jpg" % now, imgCropFinal)
                elif cam == 3:
                    cv2.imwrite("Hasil_Gambar/R.C.Camera_C_ %s.jpg" % now, imgCropFinal)
                elif cam == 4:
